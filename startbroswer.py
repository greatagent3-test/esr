...
def main():
	...
	if FileUtil.has_file('FirefoxPortable/FirefoxPortable.exe'):
		os.system('start ./FirefoxPortable/FirefoxPortable.exe  -no-remote "http://greatagent-ifanqiang.github.io/greatagent2-esr/ifanqiang.htm"')
		return
	else:
	...
	if  FileUtil.has_file('GoogleChromePortable/GoogleChromePortable.exe'):
		os.system('start ./GoogleChromePortable/GoogleChromePortable.exe   --ignore-certificate-errors  "http://greatagent-ifanqiang.github.io/greatagent2-esr/ifanqiang.htm"')
		return
	else:
		print "Don't Have GoogleChromePortable"
	print 'Starting OperaPortable...'
	if  FileUtil.has_file('OperaPortable/OperaPortable.exe'):
		os.system('start ./OperaPortable/OperaPortable.exe "http://greatagent-ifanqiang.github.io/greatagent2-esr/ifanqiang.htm"')
		return
	else:
		print "Don't Have OperaPortable"
		print 'Starting MaxthonPortable...'
	if  FileUtil.has_file('MaxthonPortable/MaxthonPortable.exe'):
		os.system('start ./MaxthonPortable/MaxthonPortable.exe "http://greatagent-ifanqiang.github.io/greatagent2-esr/ifanqiang.htm"')
		return
	else:
